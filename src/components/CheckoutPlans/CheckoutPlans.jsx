              ...
              >
                <label className={CheckoutPlansCss.container2}>
                  <input
                    ...
                    onChange={(e) =>
                      setstate({ ...state, plan: e.target.value })
                    }
                  />
              ...
              {plans
                ...
                .map((plan) => (
                  <div
                    ...
                    style={
                      box.adOnsBox ? { display: 'flex' } : { display: 'none' }
                    }
                    onClick={() =>
                      setstate({ ...state, adOns: plan.add_on.id })
                    }
                  >
                    <label className={CheckoutPlansCss.container2}>
                      <input
                        ...
                        checked={state.adOns === plan.add_on.id}
                        onChange={(e) =>
                          setstate({ ...state, adOns: e.target.value })
                        }
                      />
                      <span className={CheckoutPlansCss.checkmark}></span>
                    </label>
