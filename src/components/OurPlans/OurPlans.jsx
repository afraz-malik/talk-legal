          ...
          <table>
              ...
              <tr>
                <td width="400px">
                  <div className={OurPlansCss.title}>
                    ...
                    <p>
                      Choose a plan that works best for you and your team. No
                ...
                {plans.map((plan) => (
                  <td key={plan.id}>
                    ...
                    >
                      ...
                      <button onClick={() => handleClick(plan)}>Select</button>
                    </div>
                  </td>
                ))}
              </tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                {plans.map((plan) => (
                  <td key={plan.id}>
                    {plan.add_on ? <img alt="" src="images/Shape.png" /> : null}
                  </td>
                ))}
              </tr>
              <tr>
                ...
                {plans.map((plan) => (
                  <td key={plan.id}>
                    {plan.membership_description.replace(/(^.*\(|\).*$)/g, '')}
                  </td>
                ))}
              </tr>
            </tbody>
