    ...
    <div className={TrustersCss.container}>
      <div className={TrustersCss.inside}>
        ...
        <div className={TrustersCss.imgbox}>
          <img alt="" src="images/Ellipse 15.png" className={TrustersCss.img} />
          <img
            alt=""
        ...
        <div className={TrustersCss.imgbox1}>
          <img alt="" src="images/Ellipse 29.png" className={TrustersCss.img} />
          <img
            alt=""
        ...
        <div className={TrustersCss.imgbox2}>
          <img alt="" src="images/Ellipse 28.png" className={TrustersCss.img} />
          <img
            alt=""
        ...
        <div className={TrustersCss.imgbox3}>
          <img alt="" src="images/Ellipse 30.png" className={TrustersCss.img} />
          <img
            alt=""
        ...
        <div className={TrustersCss.imgbox4}>
          <img alt="" src="images/Ellipse 27.png" className={TrustersCss.img} />
          <img
            alt=""
        ...
        <div className={TrustersCss.imgbox5}>
          <img alt="" src="images/Ellipse 26.png" className={TrustersCss.img} />
          <img
            alt=""
        ...
        <div className={TrustersCss.imgbox6}>
          ...
          <img alt="" src="images/right.png" className={TrustersCss.rightimg} />
        </div>
        ...
        <div className={TrustersCss.centered}>
          ...
          />
          <img alt="" src="images/quotes.svg" className={TrustersCss.quotes} />
