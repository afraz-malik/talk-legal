    ...
    <div className={AdOnsCss.ad_ons}>
        ...
        >
          <label className={AdOnsCss.container2}>
            <input
              ...
              onChange={(e) => setstate({ plans: e.target.value, adOns: '' })}
            />
            <span className={AdOnsCss.checkmark}></span>
          </label>
          <div className={AdOnsCss.text}>
      ...
      {state.plans === 'platinum' ? null : (
        <div className={AdOnsCss.ad_on}>
          <div
            className={AdOnsCss.box}
            onClick={() => setbox({ ...box, adOnsBox: !box.adOnsBox })}
          >
            <h3>Add ons</h3>
            <img
              alt=""
          ...
          <div
            className={`${AdOnsCss.card} ${
              state.adOns === 'unlimited' ? AdOnsCss.activeCard : null
            }`}
            style={box.adOnsBox ? { display: 'flex' } : { display: 'none' }}
            onClick={() => setstate({ ...state, adOns: 'unlimited' })}
          >
            <label className={AdOnsCss.container2}>
              <input
                type="radio"
                ...
                onChange={(e) => setstate({ ...state, adOns: e.target.value })}
              />
              <span className={AdOnsCss.checkmark}></span>
            </label>
            <div className={AdOnsCss.text}>
              ...
              <p>Unlimited 30-minute sessions per month(no refunds).</p>
            </div>
          </div>
          <div
            className={`${AdOnsCss.card} ${
